...
desiredOrbitSemiMajorAxis = marsRadius+320.0; % a [kmMOLA]
desiredOrbitEccentricity = 0.0; % e [-]
desiredOrbitInclination = deg2rad(45.0); % i [rad]
desiredRAAN = 0.911129025690403-deg2rad(0.01); % Omega [rad]
...
RKFpath = fullfile('RKF','backupRKFFileAtDateAndTime_2016-08-31_15:02:05.csv'); % Create the path for the RKF file
TSIpath = fullfile('TSI','backupSpherical(Cart)TSIFileAtDateAndTime_2016-08-31_15:02:05.csv'); % Create the path for the TSI file
